...
import Dinnernonveg from './Dinnernonveg';
import DinnerVeg from './DinnerVeg';
...
const Tabs = ({ navigation }) => {
    ...
    return (
        ...
        >
            <Tab.Screen name="Dinnernonveg" component={Dinnernonveg}
                options={{
                    tabBarIcon: ({ focused }) => (
                        <View>
            ...
            <Tab.Screen name="DinnerVeg" component={DinnerVeg}
                options={{
                    tabBarIcon: ({ focused }) => (
                        <View>
