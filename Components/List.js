                    ...
                    >
                        <View
                            ...
                            <Image style={{
                                ...
                                source={require("../Assets/Soup/two.jpg")} />
                    ...
                    >
                        <View
                            ...
                            <Image style={{
                                ...
                                source={require("../Assets/Soup/one.jpg")} />
                            <View style={{ marginLeft: -28, flexDirection: "row" }}>
                                <View>
                                    <Text style={styles.HeadingText}>
                                        The Tini Dragon</Text>
                    ...
                    >
                        <View
                            ...
                            <Image style={{
                                ...
                                source={require("../Assets/Soup/panner.jpg")} />
                            <View style={{ marginLeft: -28, flexDirection: "row" }}>
                                <View>
                                    <Text style={styles.HeadingText}>
                                        The Tini Dragon</Text>
                    ...
                    >
                        <View
                            ...
                            <Image style={{
                                ...
                                source={require("../Assets/Soup/breakfast.jpg")} />
                            <View style={{ marginLeft: -28, flexDirection: "row" }}>
                                <View>
                                    <Text style={styles.HeadingText}>
                                        The Tini Dragon</Text>
                    ...
                    >
                        <View
                            ...
                            <Image style={{
                                ...
                                source={require("../Assets/Soup/dessert.jpg")} />
                            <View style={{ marginLeft: -28, flexDirection: "row" }}>
                                <View>
                                    <Text style={styles.HeadingText}>
                                        The Tini Dragon</Text>
