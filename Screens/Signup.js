...
function SignInScreen({ navigation }) {
    ...
    const signupHandle = (userName, password, email) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Image style={{
                    height: 300, width: "95%", resizeMode: "contain", alignSelf: 'center', marginTop: -30
                }}
                    source={require("../Assets/LibrarialOrange.png")} />
            </View>
